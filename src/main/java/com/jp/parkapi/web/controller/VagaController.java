...
import com.jp.parkapi.service.VagaService;
import com.jp.parkapi.web.dto.VagaCreateDto;
import com.jp.parkapi.web.dto.VagaResponseDto;
import com.jp.parkapi.web.dto.mapper.VagaMapper;
...
public class VagaController {
    ...
    @Operation(summary = "Localizar uma vaga", description = "Recurso para retornaruma vaga pelo seu código" +
            "Requisição exige uso de um bearer token. Acesso restrito a Role='ADMIN'",
            security = @SecurityRequirement(name = "security"),
            responses = {
