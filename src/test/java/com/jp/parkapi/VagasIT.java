...
@Sql(scripts = "/sql/vagas/vagas-insert.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD) // Executando o script antes do método
@Sql(scripts = "/sql/vagas/vagas-delete.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD) // Executando o script depois do método
public class VagasIT {
    ...
    public void criarVaga_comDadosInvalidos_RetornarErrorMessageStatus422(){
        ...
        testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "ygor@email.com", "123456"))
                .bodyValue(new VagaCreateDto("A-011","DESOCUPADO"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody()
                .jsonPath("status").isEqualTo(422)
    ...
    @Test
    public void buscarVaga_comCodigoJaInexistente_RetornarErrorMessageStatus404(){
        testClient
                .get()
    ...
    public void criarVaga_comUsuarioSemPermissaoDeAcesso_RetornarErrorMessageStatus403(){
        testClient
                ...
                .bodyValue(new VagaCreateDto("A-12","LIVRE"))
                .exchange()
